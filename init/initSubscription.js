...
const initValue = {
    _id: "subscription",
    plans: [
      { _id: "sub_low", price: "2.99", detail: getDetail('10'), cards: 10 },
      { _id: "sub_med", price: "3.99", detail: getDetail('20'), cards: 20 },
      { _id: "sub_high", price: "9.99", detail: getDetail('unlimited'), cards: 1000 }
    ]
};
